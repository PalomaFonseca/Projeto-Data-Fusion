...
<body>
    ...
    <main>
        ...
        <div class="input-group">
            ...
            <!--PESQUISA-->
            <a href="edicao/fichaPaciente.php" class="btn btn-outline-secondary" type="button"><i class="bi bi-search"></i></a>
            <!--ADICIONA-->
            <a href="cadastroPaciente.php" class="btn btn-outline-secondary" type="button"><i class="bi bi-person-plus-fill"></i></a>
        </div>
    </main>
